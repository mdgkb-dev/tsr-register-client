    ...
    <el-row>
      <el-collapse class="collapse">
        <el-form ref="form" label-position="top" :status-icon="true" :model="patient">
          ...
          <el-collapse-item v-for="registerGroupToRegister in register.registerGroupToRegister" :key="registerGroupToRegister">
            <template #title>
            ...
            >
              ...
              <el-form-item v-if="prop.registerProperty.valueType.isRadio()" :label="prop.registerProperty.name">
                ...
                <el-input
                  ...
                  :rows="3"
                  :model-value="
                    patient.getOtherPropertyValue(registerGroupToRegister.registerGroup.registerPropertyToRegisterGroup[j].registerProperty)
                  "
