<template>
  ...
  <div v-if="mount" class="table-background">
    <el-table :default-sort="{ prop: 'id', order: 'ascending' }" :data="registers" class="table-shadow" header-row-class-name="header-style">
      <el-table-column type="index" width="50" />
      <el-table-column prop="name" label="Название регистра" width="150" />
