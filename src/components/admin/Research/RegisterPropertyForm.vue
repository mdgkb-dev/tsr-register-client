...
import RegisterPropertyExamplesForm from '@/components/admin/Research/RegisterPropertyExamplesForm.vue';
import RegisterPropertyMeasuresForm from '@/components/admin/Research/RegisterPropertyMeasuresForm.vue';
import RegisterPropertyRadioForm from '@/components/admin/Research/RegisterPropertyRadioForm.vue';
import RegisterPropertySetForm from '@/components/admin/Research/RegisterPropertySetForm.vue';
import RegisterPropertyVariantsForm from '@/components/admin/Research/RegisterPropertyVariantsForm.vue';
