            ...
            <div class="flex-block" @click.prevent="() => undefined">
              <div class="item-flex">
                <div class="line-item-left">
                  ...
                  <StringItem :string="patient.human.getFullName()" color="#006BB4" font-size="17px" min-width="240px" width="100%" />
                </div>
                <div class="line-item-right">
                  <StringItem :string="patient.human.getGender()" color="#343E5C" font-size="20px" @click="updateIsMale(patient.human)" />
                  <InfoItem margin="0" :with-open-window="false">
                    <template #title>
