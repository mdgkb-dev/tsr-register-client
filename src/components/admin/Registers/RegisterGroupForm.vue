...
import RegisterPropertyForm from '@/components/admin/Research/RegisterPropertyForm.vue';
...
export default defineComponent({
  ...
  setup() {
    ...
    const newRegisterProperty: Ref<IRegisterProperty> = ref(new Question());
    ...
    const addRegisterProperty = (registerGroup: IRegisterGroup, index: number): void => {
      ...
      newRegisterProperty.value = new Question();
      // store.commit('registers/setActiveCollapseName', String(index));
    };
